...
$blogger_name=$_SESSION['username'];
$query="SELECT * FROM blog_detail natural join blog_master WHERE blog_author='$blogger_name'";
			...
			<div class="wrap">
			     ...
			     <div class="login_button">
			    	<ul>
			    		...
			    		<li><a href="logout.php">Logout</a></script></li>
			   		</ul>	
			    </div>
				<div class="clear"></div>
			</div>
			...
			<div class="wrap">
				<div class="menu">
				    <ul>
				    	...
				    	<li><a href="blog.php">Write ARTICLES</a></li>
				    	...
				    	<li><a href="contact.php?name=<?php echo $blogger_name; ?>">CONTACT</a></li>
				    </ul>
				</div>
...
<?php  
if($count==0){
	echo "You have not posted anything yet  ". $_SESSION['username'];
}
